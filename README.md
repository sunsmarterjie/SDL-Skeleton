...
Attention：evaluation code is newly updated [here](https://pan.baidu.com/s/1ZZwZLdYZjAOSXDlNfT7Zeg), password is x9bd. Many guys want the pretrained model, which missed during the machine clearing. I will re-run AdaLSN and share the pretrained model.
